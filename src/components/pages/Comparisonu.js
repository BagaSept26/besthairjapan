...
import Image from '../pages/Comparison';
import Handle from '../pages/Comparisonc';

import '../styles/Header.css';

function Comparisonu({ original, modified, delay = 0 }) {
