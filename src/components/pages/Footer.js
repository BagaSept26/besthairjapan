...
// import components
import Newsletter from '../pages/Kabar';
import Copyright from '../pages/Copyright';
import Socials from '../pages/Sosmed';
// import data
...
const Footer = () => {
  ...
  return (
    <footer className='relative top-96 z-20 bg-dark lg:bg-transparent lg:min-h-[620px] lg:bg-about lg:bg-center lg:bg-no-repeat pt-20 lg:pt-32'>
